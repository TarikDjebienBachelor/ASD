 ...
 */
public class ModifiedQuickSort2 extends SortAlgorithm {
	 ...
	 * 
	 */
	public ModifiedQuickSort2(boolean randomized, int cut) {
		super();
	...
	public String getName() {
		return "QuickSort + InsertionSort(" + cut + ") v2 " + (randomized ? "random" : "normal");
	}
